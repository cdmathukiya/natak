                    ...
                    <div>
                        ...
                        <form @submit.prevent="submitForm()">
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" id="password" v-model="form.password" placeholder="Enter your password"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        <span @click="showPassword = !showPassword"
                                            class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400">
                                            <svg :class="showPassword ? 'hidden' : ''" class="fill-current" width="20"
                                ...
                                <div>
                                    <label for="checkboxLabelOne"
                                        ...
                                        <div class="relative">
                                            <input type="checkbox" id="checkboxLabelOne" v-model="form.tac" value="1" class="sr-only"
                                ...
                                <div>
                                    <button class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition"
                                        ...
                                        {{ form.processing ? 'Sign Up...' : 'Sign Up' }}
                                    </button>
                                </div>
                            </div>
                        </form>
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                ...
                                <Link :href="route('login')" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">
                                    Sign In
                                </Link>
                            </p>
                        </div>
