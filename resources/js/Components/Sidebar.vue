<template>
    <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'" class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 transition-all duration-300 bg-white px-5 dark:border-gray-800 dark:bg-black lg:static lg:translate-x-0">
        <!-- SIDEBAR HEADER -->
            ...
            <nav>
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-4 mb-6">
                        <!-- Menu Item Dashboard -->
                        <li>
                            <Link :href="route('dashboard')" class="menu-item group" :class="isActiveRoute(route('dashboard')) ? 'menu-item-active' : 'menu-item-inactive'">
                                <svg :class="isActiveRoute(route('dashboard')) ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Menu Item User -->
                        <li>
                            <Link :href="route('team_availables')" class="menu-item group" :class="isActiveRoute(route('team_availables')) ? 'menu-item-active' : 'menu-item-inactive'">
                                <i class="fa-solid fa-users text-xl"></i>
                                <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                                    Team Availables
                                </span>
